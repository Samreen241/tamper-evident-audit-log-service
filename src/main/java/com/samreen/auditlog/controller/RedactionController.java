...
public class RedactionController {
  ...
  public RedactionController(RedactionFacade facade) {
    this.facade = facade;
  }

  @PostMapping
  @Operation(
      summary = "Redact approved sensitive fields",
      security = @SecurityRequirement(name = "bearerAuth"))
  public RedactionResponse redact(
      @PathVariable UUID eventId, @Valid @RequestBody RedactionRequest request) {
    return facade.redact(eventId, request);
  }
}
